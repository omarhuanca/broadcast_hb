...
import io.umss.app.br.broadcast_hb.service.SubscriberService;
...
public class SubscriberResource {
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        Page<SubscriberDTOV> objectList;
    ...
    @PostMapping
    public ResponseEntity<Object> saveObject(@Valid @RequestBody SubscriberDTOV objectDTOV,
            HttpServletRequest request) {
        Subscriber object = new Subscriber();
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateObject(@Valid @RequestBody SubscriberDTOV objectDTOV,
            @PathVariable("id") Long id, HttpServletRequest request) {

        Optional<Subscriber> objectOptional = Optional.empty();
        Subscriber object = new Subscriber();
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);
