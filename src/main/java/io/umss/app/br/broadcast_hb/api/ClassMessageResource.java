...
import io.umss.app.br.broadcast_hb.service.ClassMessageService;
...
public class ClassMessageResource {
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        Page<ClassMessageDTOV> objectList;
    ...
    public ResponseEntity<Object> updateObject(@Valid @RequestBody ClassMessageDTOV objectDTOV,
        ...
        Optional<ClassMessage> objectOptional = Optional.empty();
        ClassMessage object = new ClassMessage();
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);
