...
import io.umss.app.br.broadcast_hb.service.SubscriptionService;
...
public class SubscriptionResource {
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        Page<SubscriptionDTOV> objectList;
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateObject(@Valid @RequestBody SubscriptionDTOV objectDTOV,
            @PathVariable("id") Long id, HttpServletRequest request) {

        Optional<Subscription> objectOptional = Optional.empty();
        Subscription object = new Subscription();
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);
